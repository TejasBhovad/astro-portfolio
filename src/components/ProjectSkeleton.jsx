...
const ProjectContainer = ({ title, description}) => {
  return (
    <div className="cursor-pointer flex-col h-64 w-52 bg-lightBackground dark:bg-darkBackground rounded-md project-container animate-pulse">
      <div className="image-contain bg-lightSecondary dark:bg-darkBackground h-32 w-full rounded-t-md object-contain flex animate-pulse">
        {/* <img
          src={image}
          alt=""
